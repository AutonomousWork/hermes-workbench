...
operator explicitly adopts the current healthy configuration. A later manual or
scheduled image update retries auto-adoption when the baseline is still missing.
